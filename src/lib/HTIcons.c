...
PUBLIC void HTStdIconInit ARGS1(CONST char *, url_prefix)
{
    ...
    HTAddBlankIcon  (prefixed(p,"blank.gif"),	NULL	);
    HTAddDirIcon    (prefixed(p,"directory.gif"),"DIR"	);
    HTAddParentIcon (prefixed(p,"back.gif"),	"UP"	);
    HTAddUnknownIcon(prefixed(p,"unknown.gif"),	NULL	);
    HTAddIcon(prefixed(p,"unknown.gif"),	NULL,	"*/*");
    HTAddIcon(prefixed(p,"binary.gif"),		"BIN",	"binary");
    HTAddIcon(prefixed(p,"unknown.gif"),	NULL,	"www/unknown");
    HTAddIcon(prefixed(p,"text.gif"),		"TXT",	"text/*");
    HTAddIcon(prefixed(p,"image.gif"),		"IMG",	"image/*");
    HTAddIcon(prefixed(p,"movie.gif"),		"MOV",	"video/*");
    HTAddIcon(prefixed(p,"sound.gif"),		"AU",	"audio/*");
    HTAddIcon(prefixed(p,"compressed.gif"),	"CMP",	"compress");
    HTAddIcon(prefixed(p,"compressed.gif"),	"GZP",	"gzip");
    HTAddIcon(prefixed(p,"index.gif"),		"IDX",	"application/x-gopher-index");
    HTAddIcon(prefixed(p,"index2.gif"),		"CSO",	"application/x-gopher-cso");
    HTAddIcon(prefixed(p,"telnet.gif"),		"TEL",	"application/x-gopher-telnet");
    HTAddIcon(prefixed(p,"unknown.gif"),       	"DUP",	"application/x-gopher-duplicate");
    HTAddIcon(prefixed(p,"unknown.gif"),	"TN",	"application/x-gopher-tn3270");
}
